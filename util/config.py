...
class Config(object):
    ...
    def _read_combat(self, config):
        ...
        self.combat['boss_fleet_number'] = self.try_cast_to_int(config.get('Combat', 'BossFleetNumber'))
        ...
        self.combat['slot_for_rotation'] = self.try_cast_to_int(config.get('Combat', 'SlotForRotation'))
