...
data = {
    ...
    "combat/repeat": [1200, 780, 1500, 900], 
    "commission/alert_available": [250, 330, 780, 510],
    "commission/alert_completed": [1660, 400, 1760, 500],
    "commission/awakening_tactical_research": [520, 0, 928, 1080],
    "commission/button_completed": [250, 330, 780, 510],
    "commission/button_go": [250, 330, 780, 510],  
    "commission/daily_resource_development": [520, 0, 928, 1080],
    "commission/running": [520, 0, 928, 1080],
    ...
    "retirement/no_batch": [650, 250, 1200, 550], # should also inclose uplifted "no_batch" info box when batch is clicked more than once.
